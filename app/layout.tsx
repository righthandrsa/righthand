...
export const metadata: Metadata = {
  ...
  description: "Plain-language South African consumer rights education covering motor, credit, banking, and rental rights.",
};
        ...
        <footer style={{backgroundColor: '#1a2340', borderTop: '1px solid #2d4a6e', padding: '48px 0 28px'}}>
          <div className="max-w-6xl mx-auto px-8">
            <div className="grid gap-12 mb-10" style={{gridTemplateColumns: '2fr 1fr 1fr 1fr'}}>
              ...
              {[
                { heading: 'Learn', links: [['Motor Rights', '/learn'], ['Credit & Debt', '/learn'], ['Banking', '/learn'], ['Renting', '/learn']] },
