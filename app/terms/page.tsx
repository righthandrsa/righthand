    ...
    <main>
      <div style={{backgroundColor: '#1a5ea5', padding: '56px 0 48px'}}>
        <div className="max-w-4xl mx-auto px-5 sm:px-8">
          ...
          <h1 className="text-4xl font-bold mb-4" style={{color: '#ffffff'}}>Terms of Use</h1>
      ...
      <div style={{backgroundColor: '#ffffff'}}>
        <div className="max-w-4xl mx-auto px-5 sm:px-8 py-12">
          <article style={{color: '#1a1a1a'}}>
            ...
            <p className="text-gray-700 mb-4">You must be at least 18 years old to create an account or subscribe to a paid plan. By using this Platform, you confirm that you are at least 18 years of age.</p>

            <h2 className="text-xl font-bold mt-8 mb-3" style={{color: '#0C447C', borderBottom: '1px solid #E2E0D8', paddingBottom: '8px'}}>4. Free and paid content</h2>
            <p className="text-gray-700 mb-4">Certain modules are available free of charge without registration. Access to all remaining modules requires an active paid subscription at the then-current subscription fee (currently R99 per month).</p>
            <p className="text-gray-700 mb-4">Subscription fees are billed monthly in advance. You may cancel your subscription at any time. Cancellation takes effect at the end of your current billing period; no partial-month refunds are issued unless required by applicable law.</p>

            <h2 className="text-xl font-bold mt-8 mb-3" style={{color: '#0C447C', borderBottom: '1px solid #E2E0D8', paddingBottom: '8px'}}>5. Acceptable use</h2>
            <p className="text-gray-700 mb-3">You agree not to:</p>
            <ul className="text-gray-700 mb-4 space-y-2 list-disc list-inside">
              <li>Reproduce, republish, or redistribute any content from the Platform without our prior written consent</li>
              <li>Use the Platform for any unlawful purpose or in violation of any South African law or regulation</li>
              ...
              <li>Use automated tools to scrape, copy, or extract content from the Platform</li>
            </ul>
            ...
            <p className="text-gray-700 mb-4">We may update these Terms of Use from time to time. We will notify registered users of material changes by email. Continued use of the Platform after any update constitutes your acceptance of the revised terms.</p>

            <h2 className="text-xl font-bold mt-8 mb-3" style={{color: '#0C447C', borderBottom: '1px solid #E2E0D8', paddingBottom: '8px'}}>10. Governing law</h2>
            <p className="text-gray-700 mb-4">These Terms of Use are governed by and construed in accordance with the laws of the Republic of South Africa. Any disputes arising from these terms shall be subject to the jurisdiction of the South African courts.</p>

            <h2 className="text-xl font-bold mt-8 mb-3" style={{color: '#0C447C', borderBottom: '1px solid #E2E0D8', paddingBottom: '8px'}}>11. Contact</h2>
            <p className="text-gray-700 mb-4">For any questions about these Terms of Use, please contact us at <a href="mailto:info@righthand.org.za" style={{color: '#1a5ea5'}}>info@righthand.org.za</a>.</p>
