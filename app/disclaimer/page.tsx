          ...
          <article style={{color: '#1a1a1a'}}>
            ...
            <div className="rounded-lg p-5 mb-8" style={{backgroundColor: '#FBEAF0', borderLeft: '4px solid #993556'}}>
              ...
              <p className="text-sm leading-relaxed" style={{color: '#1a1a1a'}}>
                RightHand is an educational platform, not a law firm. Nothing on this website constitutes legal advice. Do not act or refrain from acting on the basis of anything you read here without first consulting a qualified South African attorney.
              </p>
            </div>
            ...
            <p className="text-gray-700 mb-4">All content published on righthand.org.za by RightHand (Pty) Ltd is provided for general educational and informational purposes only. Our modules explain South African consumer rights legislation in plain language to help consumers understand the legal framework that applies to them.</p>
            ...
            <p className="text-gray-700 mb-4">Use of this Platform does not create an attorney-client relationship between you and RightHand (Pty) Ltd or any contributor to the Platform. No such relationship is created by reading any module, submitting a contact form, or subscribing to a paid plan.</p>
            ...
            <p className="text-gray-700 mb-4">Some modules include content contributed by third-party specialists in relevant fields. Contributor content reflects the views and expertise of the individual contributor and does not constitute an endorsement by RightHand (Pty) Ltd. RightHand is not responsible for any services, advice, or engagements entered into between users and contributors outside of this Platform.</p>
            ...
            <p className="text-gray-700 mb-4">To the fullest extent permitted by South African law, RightHand (Pty) Ltd, its directors, employees, and contributors shall not be liable for any loss, damage, or expense of any kind arising from your use of, or reliance on, any content on this Platform, including but not limited to any decision made or action taken in reliance on information published here.</p>
