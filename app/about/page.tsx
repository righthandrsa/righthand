    ...
    <main>
      ...
      <div style={{backgroundColor: '#1a5ea5', padding: '56px 0 48px'}}>
        <div className="max-w-4xl mx-auto px-8">
          <p className="text-xs font-bold tracking-widest uppercase mb-3" style={{color: 'rgba(255,255,255,0.65)'}}>About Right Hand</p>
      ...
      <div style={{backgroundColor: '#ffffff'}}>
        <div className="max-w-4xl mx-auto px-8 py-16">
          ...
          <div className="mb-16" style={{maxWidth: '720px'}}>
            ...
            <p className="text-lg leading-relaxed" style={{color: '#1a1a1a'}}>That is the gap Right Hand was built to close.</p>
          </div>

          {/* What we do */}
          <div className="mb-16">
            <h2 className="text-2xl font-bold mb-6" style={{color: '#1a2340'}}>What we actually do</h2>
            <p className="text-base leading-relaxed mb-6" style={{color: '#374151'}}>Right Hand brings together practitioners, specialists, and regulators who work in their fields every day, and packages what they know into something any South African can actually use. The knowledge already exists. The experts already exist. What has been missing is a single place where that expertise is made accessible, structured, and presented in plain language.</p>
            <p className="text-base leading-relaxed mb-6" style={{color: '#374151'}}>Every module on Right Hand is built on the knowledge of a contributor who works directly in that field, whether that is a vehicle finance specialist, a registered debt counsellor, a chartered accountant, or a consumer rights practitioner. We bring their expertise to you in a format that takes minutes to read, not a law degree to understand.</p>
            <p className="text-base leading-relaxed" style={{color: '#374151'}}>Right Hand is not a law firm, and we do not represent, negotiate, or act on behalf of our subscribers. We are a platform that connects consumers with the knowledge they need to engage with the system on their own terms, confidently and informed.</p>
          </div>
          ...
          <div className="mb-16 rounded-lg p-6" style={{backgroundColor: '#e8f0fa', borderLeft: '4px solid #1a5ea5'}}>
            ...
            <p className="text-sm leading-relaxed" style={{color: '#1a1a1a'}}>Some of the experts and professionals who contribute content to Right Hand also offer their own independent professional services, separately from this platform. Where that is the case, we will always say so clearly. Using Right Hand never requires using anyone else's services, and we do not refer, recommend, or take payment for doing so.</p>
          </div>

          {/* Why Righthand */}
          <div className="mb-16">
            <h2 className="text-2xl font-bold mb-6" style={{color: '#1a2340'}}>Why "Right Hand"?</h2>
          ...
          <div className="mb-16">
            ...
            <div className="rounded-lg p-6" style={{backgroundColor: '#1a2340'}}>
              <p className="text-base leading-relaxed font-medium" style={{color: '#b3d0f0'}}>You do not need to be a lawyer to know your rights. You just need access to the people who already know them. That is what Right Hand is for.</p>
            </div>
          </div>
          ...
          <div className="rounded-lg p-6 mb-16" style={{backgroundColor: '#e8f0fa', borderLeft: '4px solid #1a5ea5'}}>
            ...
            <div className="space-y-2 text-sm" style={{color: '#1a1a1a'}}>
              ...
              <p><strong style={{color: '#0C447C'}}>We are NOT</strong> a law firm, advocacy group, or representative body. We do not negotiate, litigate, or act on anyone's behalf. Contributors to our content are independently available for professional services where disclosed, but their involvement with Right Hand is as knowledge contributors only.</p>
            </div>
          </div>
